...
from detector.object_detection.yolov4.utilities.detections import filter_detections
from detector.object_detection.yolov4.utilities.bboxes import bbox_iou_one_to_many
...
def greedy_nms_inplace(dets, nms_thresh=NMS_THRESHOLD):
    ...
    for i, bbox in enumerate(bboxes[:-1]):
        ...
        class_a = class_probs[i].expand_as(class_b_thresh).clone()
