...
from Yet_Another_EfficientDet_Pytorch_master.utils.sync_batchnorm import SynchronizedBatchNorm2d
...
def standard_to_bgr(list_color_name):
    standard = []
    for i in range(len(list_color_name) ):  # -36 used to match the len(obj_list) #수정!! # for i in range(len(list_color_name) - 36 ):  이었음.
