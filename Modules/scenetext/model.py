...
from Modules.scenetext.modules.transformation import TPS_SpatialTransformerNetwork
...
class Model(nn.Module):
    def __init__(self, opt):
        ...
        if opt['FeatureExtraction'] == 'VGG':
            self.FeatureExtraction = VGG_FeatureExtractor(input_channel, opt['output_channel'])
        elif opt['FeatureExtraction'] == 'RCNN':
            self.FeatureExtraction = RCNN_FeatureExtractor(input_channel, opt['output_channel'])
        elif opt['FeatureExtraction'] == 'ResNet':
            self.FeatureExtraction = ResNet_FeatureExtractor(input_channel, opt['output_channel'])
        else:
